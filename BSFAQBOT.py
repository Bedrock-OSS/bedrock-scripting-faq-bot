        ...
        if command_request:
            ...
            if (BOT_DATA.FAQ_MANAGEMENT_ROLE in [role.name for role in roles]) and (server_id in BOT_DATA.APPROVED_SERVERS):
                ...
                if action in BOT_DATA.FAQ_MANAGEMENT_COMMANDS['add']:
                    ...
                    if faq_tags_reply_content.lower() in ['x', 'X']:
                    ...
                    if faq_title_reply_content.lower() in ['x', 'X']:
                        # do nothing, since the user cancelled the FAQ creation
                        embed = discord.Embed(
                            title='',
                    ...
                    if faq_description.lower() in ['x', 'X']:
                ...
                if action in BOT_DATA.FAQ_MANAGEMENT_COMMANDS['edit']:
                    ...
                    if faq_tag_reply_content.lower() in ['x', 'X']:
                    ...
                    if faq_edit_attribute_choice.lower() in ['x', 'X']:
                        # do nothing, since the user cancelled the FAQ creation
                        embed = discord.Embed(
                            title='',
                            description=f'''**Cancelled FAQ Editing**''',
                    ...
                    if faq_edit_attribute_choice.lower() in ['t', 'title', 'T', 'Title']:
                    ...
                    elif faq_edit_attribute_choice.lower() in ['ta', 'tags', 'Ta', 'Tags']:
                    ...
                    elif faq_edit_attribute_choice.lower() in ['d', 'description', 'D', 'Description']:
                ...
                if action in BOT_DATA.FAQ_MANAGEMENT_COMMANDS['delete']:
                    ...
                    if faq_delete_reply.content in ['yes', 'Yes']:
                        # delete the FAQ
                        deleteFaq(faq_tag)
                        embed = discord.Embed(
                            title='',
